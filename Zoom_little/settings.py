"""
Django settings for Zoom_little project.
...
SECRET_KEY = '4$gccr_&+0n9wpdrc5b7exyun%x!&%f_lp_^^@7)x1-=9w6#md'
...
WSGI_APPLICATION = 'Zoom_little.wsgi.application'
